...
void setup() {
  ...
  IPAddress _ip = IPAddress(192, 168, 0, 102);  //Set static ip in AP
  IPAddress _gw = IPAddress(192, 168, 0, 1);  //AP gateway
  IPAddress _sn = IPAddress(255, 255, 255, 0);  //Subnetmask
